...
import com.jusfoun.common.annotation.Logable.LevelType;
...
public class LogableAspect extends AbstractAspect {
	private static final Logger logger = LoggerFactory.getLogger(LogableAspect.class);
	 ...
	 */
	@Pointcut("(execution(* com.jusfoun.web.controller..*(..)) || execution(* com.jusfoun.security..*(..))) && @annotation(com.jusfoun.common.annotation.Logable)")
