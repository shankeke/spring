...
/**
 * 描述 :继承SessionAwareMessageListener. <br>
 ...
 * 
 * @author Uknower-yjw
 * @date 2016-9-1 下午3:04:05
 */
@Component("reqQueueComsumer")
public class ReqQueueComsumer implements
	...
	public void onMessage(TextMessage message, Session session)
			throws JMSException {
		logger.debug("收到一条消息，消息内容是：{}", message.getText());
