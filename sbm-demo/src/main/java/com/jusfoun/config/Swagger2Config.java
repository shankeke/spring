	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()//
				...
				.description("知识点：\n"//
						...
						+ "11、Jdk特性：使用Jdk 1.8新特性解决一些特殊需求，展现一些API使用技巧和使用场景，给新手学习提供范例，如：接口默认方法、Lambda表达式、Stream等。 \n"//
						+ "12、树状数据处理：面向常见的应用场景，对于符合树状结构的数据抽象数据模型，抽象查询接口，结构化组合关系，以模式化代码实现树状结构数据的操作、检索等功能。 \n"//
						...
						+ "15、其他：二维码处理、文件上传统一接口、Spring Profiles使用、Spring Boot CommandLineRunner使用、定时任务等。\n"//
