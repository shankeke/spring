...
import com.jusfoun.web.controller.test.plupload.Plupload;
import com.jusfoun.web.controller.test.plupload.PluploadService;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

@Api(tags = "TEST-PluploadController", description = "文件断点续传测试", value = "文件断点续传接口类")
@Controller
@RequestMapping("/test")
