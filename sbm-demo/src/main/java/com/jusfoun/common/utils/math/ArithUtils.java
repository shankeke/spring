package com.jusfoun.common.utils.math;
...
public class ArithUtils {
	 ...
	 */
	/*
	 * public static double mul(double v1, double v2) { BigDecimal b1 = new
	 * BigDecimal(Double.toString(v1)); BigDecimal b2 = new
	 * BigDecimal(Double.toString(v2)); return b1.multiply(b2).doubleValue(); }
	 */
