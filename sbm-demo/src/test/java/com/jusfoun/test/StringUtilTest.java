...
public class StringUtilTest {
	...
	public void test() {
		...
		System.out.println(StringUtils.containsNone("中华中", new char[] { '中', '达', '人' }));
		...
		// 博文来源：http://
		// yijianfengvip.blog.163.com/blog/static/175273432201212221935832/
		// 替换~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// 替换指定的字符，只替换第一次出现的
		...
		// 同上，未发现不同
		System.out.println(StringUtils.replaceEachRepeatedly("www.baidu.com/baidu", new String[] { "baidu", "com" },
				new String[] { "taobao", "net" }));
	...
	@Test
	public void test1() {
		String s = "eyJhbGciOiJIUzUxMiJ9.eyJzY29wZXMiOiJyZWZyZXNoX3Rva2VuIiwic3ViIjoiYWRtaW4iLCJpc3MiOiJ3ZWJfY2xpZW50IiwiaWF0IjoxNTEyNTQzNzc5LCJleHAiOjE1MTI5NzU3Nzl9.1v-3gFeX6zqBjSc6GSCjfbuVo83ifeEjX-AC1rUcOVldG4Azm4vWYICseNb0iOKQZqrMejshHlKO2WZG8Y60og";
		System.err.println(s.length());
	}

	@Test
	public void join() {
		String[] arr = new String[] { "id = 1", "name = 'zs'", "age = 12" };
		System.out.println(StringUtils.join(arr, " AND "));
	}
}
